...
$link = mysqli_connect("localhost", "root", "", "dbase1");
...
$sql = "INSERT INTO intenship(Name,Roll_Number, department, section, batch, email, paper, college,prize,from_,to_, certificate) VALUES ('$Name','$Roll_Number','$department','$section','$batch','$email','$paper','$college','$prize','$from','$to', '$fileName') ";  
...
if(mysqli_query($link, $sql)){
	...
	move_uploaded_file($tmp_name, "certified/".($from ) .($to ) .($fileName));
} else{
